...
ResetSpritesAndScreenTimer: 
         lda #$00           ;load 0 here to stop screentimer
         nop
...
SideExitPipeEntry:
             ...
             ldy #$02
ChgAreaPipe: ldx #$00 ; ELIMINATE PIPE LOADING TIME, F*CK FRAMERULES
             ;sty ChangeAreaTimer
             nop
             bne ExitCAPipe
...
NextArea: inc AreaNumber            ;increment area number used for address loader
          ...
          dec FetchNewGameTimerFlag ;set flag to load new game timer
...
GetWNum: ldy WarpZoneNumbers,x     ;get warp zone numbers
         ...
         sta FetchNewGameTimerFlag ;set flag to load new game timer
ExPipeE: rts                       ;leave!!!
